...
describe('ImagemBase64', () => {
  ...
  const exemplos = {
    ...
    png: {
      ...
      dataUri: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAACklEQVR4nGMAAQAABQABDQottAAAAABJRU5ErkJggg=='
    }
  };
  ...
  describe('Tratamento de Erros', () => {
    ...
    test('lança erro quando solicitado em isValid', () => {
      const img = new ImagemBase64('não é base64');
      expect(() => img.isValid({ raiseException: true }))
        .toThrow('Invalid base64 image');
    });
  });
});